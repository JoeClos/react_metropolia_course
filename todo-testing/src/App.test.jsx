...
import "@testing-library/jest-dom"; // This line automatically extends expect
import App from "./App";
import { expect, test } from "vitest";

test("renders App component", () => {
  render(<App />);
  const header = screen.getByText("My Todolist"); // Ensure the text matches exactly what's rendered
